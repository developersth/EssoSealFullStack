...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/sealins', title: 'นำซีลเข้าระบบ', icon: 'ft-server', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/tabletest', title: 'ตารางข้อมูล Prime NG', icon: 'ft-file-text', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
